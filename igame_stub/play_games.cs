...
namespace IntroCS
{
	...
	public class PlayGames
	{
		...
		public static void Main()
		{
			...
			games.Add (new GuessGame (100));
			games.Add (new Gamble ());
			...
			do {
				...
				totScore = totScore + g.Play();  // use numerical result from the game
				Console.WriteLine(" ");
			} while (games.Count > 0 && UI.Agree("Want another game? "));
